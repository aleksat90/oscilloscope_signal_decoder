...
def extract_all_samples(samples):
    ...
    # print("klasa extract all samples")
    # print(samples)
    # print(chunk_buf)
    # print("Samples len: "+ str(len(samples)) +'Tip: '+ str(type(samples)))
    # print("Chunk buf len: "+ str(len(chunk_buf)) +'Tip: '+ str(type(chunk_buf)))

    return all_samples, chunk_buf[0].start_time, chunk_buf[0].sample_period
    # return all_samples, samples[0].start_time, samples[0].sample_period
